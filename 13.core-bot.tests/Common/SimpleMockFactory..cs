...
namespace CoreBotCLU.Tests.Common
{
    /// <summary>
    ...
    public static class SimpleMockFactory
    {
        ...
        public static Mock<TRecognizer> CreateMockCluRecognizer<TRecognizer, TReturns>(TReturns returns, params object[] constructorParams)
        ...
        /// <param name="constructorParams">Optional constructor parameters for the recognizer.</param>
        /// <returns>A <see cref="Mock{TRecognizer}"/> instance.</returns>
        public static Mock<TRecognizer> CreateMockCluRecognizer<TRecognizer>(RecognizerResult returns, params object[] constructorParams)
            where TRecognizer : class, IRecognizer
        {
            var mockRecognizer = new Mock<TRecognizer>(constructorParams);
            mockRecognizer
