...
{
    public class EndDateResolverDialog : CancelAndHelpDialog
    {
        private const string PromptMsgText = "On what end date would you like to travel?";
        ...
        public EndDateResolverDialog(string id = null)
            : base(id ?? nameof(EndDateResolverDialog))
        {
